                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildSensorBadge('Air', widget.sensorData?.soilMoisture != null ? '${widget.sensorData!.soilMoisture!.toStringAsFixed(1)}%' : '-'),
                        _buildSensorBadge('Suhu', widget.sensorData?.temperature != null ? '${widget.sensorData!.temperature!.toStringAsFixed(1)}°C' : '-'),
                        _buildSensorBadge('NPK', widget.sensorData?.npkDisplay ?? '-'),
                      ],
                    ),
                  ],
                ),
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text('Mulai ${widget.type.label}', style: const TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ],
